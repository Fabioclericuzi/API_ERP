...
from companies.utils.permissions import EmployeesPermission, GroupsPermisssion
...
class EmployeeDetail(Base):
    ...
    def put(self, request, employee_id):
        ...
        if email != employee.user.email and User.objects.filter(email=email).exists():
            raise APIException("O email está em uso", code="email_already_use")
